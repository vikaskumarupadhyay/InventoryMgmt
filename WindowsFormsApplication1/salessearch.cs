...
namespace WindowsFormsApplication1
{
    public partial class salessearch : Form
    {
        ...
        private void salessearch_Load(object sender, EventArgs e)
        {
            ...
            string actualcolumn = "SELECT top 1 dbo.CompnayDetails.Name, dbo.CompnayDetails.Address , dbo.CompnayDetails.City , dbo.CompnayDetails.State, dbo.CompnayDetails.Zip, dbo.CompnayDetails.Country, dbo.CompnayDetails.Email, dbo.CompnayDetails.WebAddress, dbo.CompnayDetails.Phone, dbo.CompnayDetails.Mobile, dbo.CompnayDetails.Fax, dbo.CompnayDetails.PANNO, dbo.CompnayDetails.VATNO, dbo.CompnayDetails.CSTNO, dbo.CompnayDetails.ServiceTaxAmmount, dbo.CompnayDetails.ExciseTaxAmmount, dbo.CompnayDetails.GSTTaxAmmount, dbo.CustomerDetails.CustName, dbo.CustomerDetails.CustCompName,dbo.CustomerDetails.CustAddress, dbo.CustomerDetails.CustCity, dbo.CustomerDetails.CustState, dbo.CustomerDetails.CustZip, dbo.CustomerDetails.CustCountry,dbo.CustomerDetails.CustEmail, dbo.CustomerDetails.CustWebAddress, dbo.CustomerDetails.CustPhone, dbo.CustomerDetails.CustMobile,dbo.CustomerDetails.CustFax, dbo.CustomerDetails.CustPanNo, dbo.CustomerDetails.CustVatNo, dbo.CustomerDetails.CustCstNo,dbo.CustomerDetails.CustServicetaxRegnNo, dbo.CustomerDetails.CustExciseRegnNo, dbo.CustomerDetails.Gstregnno, dbo.customerorderdescriptions.ItemId,dbo.customerorderdescriptions.orderid, dbo.customerorderdescriptions.price, dbo.customerorderdescriptions.quantity, dbo.customerorderdescriptions.totalammount, dbo.ItemDetails.ItemName, dbo.ItemPriceDetail.MrpPrice, dbo.ItemPriceDetail.Margin, dbo.orderdetails.totalammount AS Expr1, dbo.orderdetails.Discount,dbo.orderdetails.Discountamount, dbo.orderdetails.Tax, dbo.orderdetails.Taxamount, dbo.orderdetails.WithautTaxamount, dbo.salesOrderDelivery.Delivaryid, dbo.salesOrderDelivery.DeliveryDate FROM dbo.salesOrderDelivery INNER JOIN dbo.ItemDetails INNER JOIN dbo.customerorderdescriptions ON dbo.ItemDetails.ItemId = dbo.customerorderdescriptions.ItemId INNER JOIN dbo.ItemPriceDetail ON dbo.ItemDetails.ItemId = dbo.ItemPriceDetail.ItemId INNER JOIN dbo.orderdetails ON dbo.customerorderdescriptions.orderid = dbo.orderdetails.orderid INNER JOIN dbo.CustomerDetails ON dbo.orderdetails.custid = dbo.CustomerDetails.custId ON dbo.salesOrderDelivery.Orderid = dbo.orderdetails.orderid CROSS JOIN dbo.CompnayDetails";
