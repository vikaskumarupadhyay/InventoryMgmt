    ...
    MessageBoxIcon.Warning);
        ...
        public void SetItemName()
        {
            try
            {
                ...
                string itemName = dataGridView1.Rows[0].Cells[1].Value.ToString();
                     ...
                     else
                     {
                         * */
                         ...
                         if (item != itemName)
                         {
                             ...
                             dataGridView1.Rows[dataGridView1.CurrentRow.Index - 1].Cells[1].Value = "";
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (item == itemId)
                    {
                        ...
                        dataGridView1.CurrentCell = GetCurrentRowOFGridView().Cells[1];
                        /*
                              GetCurrentRowOFGridView().Cells[3].Value = rate;
                              string quantity = GetCurrentRowOFGridView().Cells[4].Value.ToString();
                              // char ch = Convert.ToChar(quantity);
        ...
        private void dataGridView1_CellValidating(object sender, DataGridViewCellValidatingEventArgs e)
        {
            ...
            if (col == 1)
            {
                ...
                if (dataGridView1.Rows[dataGridView1.CurrentRow.Index] != null && dataGridView1.Rows[dataGridView1.CurrentRow.Index].Cells.Count > 0 && !string.IsNullOrWhiteSpace(dataGridView1.Rows[dataGridView1.CurrentRow.Index].Cells[0].Value.ToString()))
                {
